      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <div className="flex-shrink-0 pt-6 pb-4 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {/* Game status */}
            <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full ${status.bg} ${status.color} border border-current/20`}>
              {status.icon}
        ...
        {/* Main content */}
        <div className={`flex-1 overflow-y-auto px-4 pb-6 transition-all duration-1000 ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="max-w-4xl mx-auto">
            {/* Story bottom */}
            <div className="bg-gradient-to-br from-amber-500/10 to-orange-500/10 backdrop-blur-lg rounded-2xl border border-amber-500/20 p-6 md:p-8 mb-6 shadow-lg shadow-amber-500/10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl text-white font-medium hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg shadow-blue-500/20 flex items-center justify-center gap-2 text-lg hover:scale-105 active:scale-95"
              >
              ...
              <button
                onClick={handleBackToGame}
                className="px-8 py-4 bg-white/10 border border-white/20 rounded-xl text-white font-medium hover:bg-white/20 transition-all duration-200 flex items-center justify-center gap-2 text-lg hover:scale-105 active:scale-95"
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                </svg>
